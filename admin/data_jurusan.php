...
<div class="kanan">
	...
	<a href="tambah_jurusan.php"><input type="submit" value="Tambah Data"></a><p>
	<table border="1">
	<tr>
	...
	<tr>
		...
		<td align="center"><a href="edit_jurusan.php?id_jurusan=<?php echo $id_jurusan ?>"> EDIT</a></td>
		<td align="center"><a href="proses/hapus_jurusan.php?id_jurusan=<?php echo $id_jurusan ?>">HAPUS</a></td>
	</tr>
	<?php
	}
	?>
